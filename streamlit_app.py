...
metrics=['accuracy'])
# Save best model
checkpoint = ModelCheckpoint("mobilenetv2_dhcd.keras", monitor='val_accuracy',
...
# Optional: Save entire model (for later use)
model.save("mobilenetv2_dhcd_full.keras")
...
uploaded_file = st.file_uploader("📤 Upload Devanagari manuscript image", type=["jpg", "png",
"jpeg"])
